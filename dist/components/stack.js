...
class Stack extends React.Component {
    ...
    render() {
        ...
        return (<react_native_screens_1.ScreenContainer style={react_native_1.StyleSheet.absoluteFill}>
        {stack.map(route => {
            ...
            return (<react_native_screens_1.Screen key={route.id} active={active} style={react_native_1.StyleSheet.absoluteFillObject}>
              <RouteComponent route={route.id} transitionContext={transitionContext} navigator={navigator}/>
